        ...
        case 'rowscas':
            return (
                <div className="all-videos CJ">
                    ...
                    <p>
                        Charles (CJ) Pape was a beloved friend and a constant companion when times were hard. He could always empathize with the difficulties of others based on his own experiences. There was nothing he loved more in life than playing video games with his friends, and will be deeply missed by the creators of this web site.
                        <br></br>
                        <br></br>
